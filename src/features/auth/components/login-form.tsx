            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          className="h-10 transition-all focus-visible:ring-2"
                          disabled={isPending}
                          {...field}
                        />
                      </FormControl>
                      ...
                      <FormControl>
                        <div className="relative">
                          <Input
                            ...
                            className="h-10 pr-10 transition-all focus-visible:ring-2"
                            disabled={isPending}
                            {...field}
                          />
                          <button
                ...
                <div className="grid gap-3">
                  <Button
                    variant="outline"
                    className="w-full gap-2 font-medium transition-all hover:bg-accent"
                    type="button"
                    disabled={isPending}
                  >
